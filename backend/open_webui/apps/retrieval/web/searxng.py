...
import requests
from night_skies.apps.retrieval.web.main import SearchResult, get_filtered_results
...
def search_searxng(
    ...
    **kwargs,
    ...
    response = requests.get(
        query_url,
        headers={
            "User-Agent": "Open WebUI (https://github.com/night-skies/night-skies) RAG Bot",
            "Accept": "text/html",
